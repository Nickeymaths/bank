...
type LoginUserResponse struct {
	...
	AccessTokenCreatedAt  *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=access_token_created_at,json=accessTokenCreatedAt,proto3" json:"access_token_created_at,omitempty"`
	RefreshToken          string                 `protobuf:"bytes,5,opt,name=refresh_token,json=refreshToken,proto3" json:"refresh_token,omitempty"`
	RefreshTokenCreatedAt *timestamppb.Timestamp `protobuf:"bytes,6,opt,name=refresh_token_created_at,json=refreshTokenCreatedAt,proto3" json:"refresh_token_created_at,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *LoginUserResponse) GetAccessTokenCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.AccessTokenCreatedAt
	}
	return nil
}
...
func (x *LoginUserResponse) GetRefreshTokenCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.RefreshTokenCreatedAt
	}
	return nil
}
...
const file_rpc_login_user_proto_rawDesc = "" +
	...
	"\x17access_token_created_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x14accessTokenCreatedAt\x12#\n" +
	"\rrefresh_token\x18\x05 \x01(\tR\frefreshToken\x12S\n" +
	"\x18refresh_token_created_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x15refreshTokenCreatedAtB Z\x1egithub.com/Nickeymaths/bank/pbb\x06proto3"
...
var file_rpc_login_user_proto_depIdxs = []int32{
	...
	3, // 1: pb.LoginUserResponse.access_token_created_at:type_name -> google.protobuf.Timestamp
	3, // 2: pb.LoginUserResponse.refresh_token_created_at:type_name -> google.protobuf.Timestamp
